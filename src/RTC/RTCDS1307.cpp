...
bool RTCDS1307::syncWithNTPDate()
{
    ...
    //Serial.println(String() + dayStr + " " + ntp.date + "-" + ntp.month + "-" + ntp.year);
...
bool RTCDS1307::syncWithNTPTimeNDate()
{
    ...
    //Serial.println("Syncronizing RTC and NTP...");
    ...
    //Serial.println(String() + dayStr + " " + rtc.date + "-" + rtc.month + "-" + rtc.year);
    return a;
}
